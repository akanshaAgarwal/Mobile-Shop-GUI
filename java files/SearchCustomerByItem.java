...
public class SearchCustomerByItem implements ActionListener {
	...
	public SearchCustomerByItem() {
		searchCust = new JDialog();
		searchCust.setBackground(Color.WHITE);
		JLabel title=new JLabel("Enter the Item Id of the Purchase");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj==searchBtn) {
			...
			String query = "select * from customers where item=?";
