...
public class RemoveProductByCost implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj==deleteBtn) {
			...
			String query = "delete from products where cost=?";
			
			try {
				PreparedStatement ps = c.prepareStatement(query);
				ps.setInt(1, Integer.parseInt(Pcost));
				ps.executeUpdate();
